@extends('layouts.app')
@section('title', $barang->nama_barang.' - Edit Barang | BINUS CANTEEN')
...
<div class="form-wrapper col-md-4">
    ...
    <form action="{{ route('updateBarang', $barang->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <img src="data:image/jpeg;base64,<?php echo base64_encode(file_get_contents($barang->foto_barang)); ?>" alt="{{ $data->nama_barang }}" class="w-100">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control @error('stok') is-invalid @enderror"" placeholder="Masukkan stok makanan" name="stok" value="{{ $barang->jumlah_barang }}">
            @error('stok')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
