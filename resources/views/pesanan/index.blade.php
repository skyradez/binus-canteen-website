@extends('layouts.app')
@section('title', 'Kelola Pesanan - BINUS CANTEEN')
...
<div class="d-flex justify-content-center mt-5">
    <div class="col-md-8">
        ...
        @if(Auth::user()->role == 'Admin')
            <h1 class="fs-3 mb-3"><i class="uil uil-history me-1"></i> KELOLA PESANAN</h1>
        ...
        @elseif(Auth::user()->role == 'Member')
            <h1 class="fs-3 mb-3"><i class="uil uil-history me-1"></i> RIWAYAT PESANAN KAMU</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima odit vitae adipisci perferendis odio impedit doloribus ipsam minus quibusdam fuga.</p>
